import { ErrorPageComponent, lastVisitedNotAuthRouteStore, Loader } from '@/components';
...
import { useAppContext, type TAppContext } from './app-context';
...
const PageWrapper = <TProps extends Props = {}, TQueryResult extends QueryResult | undefined = undefined>({
  ...
  }, [redirectNeeded, navigate, lastVisitedNotAuthRouteStore]);
  ...
  try {
    ...
    const exactTitle = isTitleExact ? calculatedTitle : `${calculatedTitle} — Design App`;
    return (
      <>
        <Helmet>
