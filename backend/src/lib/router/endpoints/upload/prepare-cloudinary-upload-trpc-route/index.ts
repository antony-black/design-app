import { cloudinaryUploadTypes } from '@design-app/shared/src/types/cloudinary-types';
import { v2 as cloudinary } from 'cloudinary';
import { env } from 'process';
import { zPrepareCloudinaryUploadTrpcSchema } from '../../../../../schemas/z-prepare-cloudinary-upload-schema';
import { trpcLoggedProcedure } from '../../../../trpc';

export const prepareCloudinaryUploadTrpcRoute = trpcLoggedProcedure
  .input(zPrepareCloudinaryUploadTrpcSchema)
